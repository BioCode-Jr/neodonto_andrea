...
const Footer = () => {
  return (
    <footer
      className='flex flex-col md:flex-row w-full min-h-60 bg-dark-pink text-white px-10 py-10 gap-10'
      id='contato'
    >
      ...
      <div className='flex flex-col justify-center w-full gap-4'>
        <div className='flex flex-col md:flex-row gap-10 justify-between px-4 md:px-32'>
          <div className='flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-2 text-xl'>
              ...
              <span>
                <b>Email:</b>{' '}
                <a href='mailto:andrea.vm1970@gmail.com'>
        ...
        <span className='flex items-end self-end mt-4 md:mt-0'>
